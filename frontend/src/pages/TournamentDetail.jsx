...
export default function TournamentDetail() {
  ...
  async function handleAddPlayer() {
    ...
    await doAction(() =>
      actions.addPlayer(Number(selectedPlayer))
    );
  ...
  // tournament is always 10 players, so it is always 4 rounds
  const maxRound = 4;
      ...
      {tournament.status === "pending" && (
        ...
        <div className="card">
          ...
          <p>
            ...
            {players.length} / 10 Players Added
                  ...
                  <tr key={player.id}>
                    ...
                    <td>
                      ...
                      <button
                        ...
                        onClick={() =>
                          doAction(() =>
                            actions.removePlayer(player.player_id)
                          )
                        }
                      >
          ...
          <div className="card">
            ...
            {pendingMatches.length > 0 && (
              ...
              <button
                ...
                disabled={working}
                onClick={() =>
                  doAction(actions.completeRound)
                }
              >
